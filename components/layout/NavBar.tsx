...
export default function NavBar() {
  return (
    <header className="sticky top-0 z-50 border-b border-neutral-200 bg-background/60 backdrop-blur-md">
      <div className="mx-auto grid h-18 max-w-6xl grid-cols-3 items-center px-6">
        {/* Left Nav */}
        <nav className="flex items-center gap-6 text-md text-neutral">
